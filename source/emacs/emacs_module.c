...
typedef emacs_value (*emacs_function)(emacs_env *env, ptrdiff_t nargs,
                                      emacs_value *args,
                                      void *data) EMACS_NOEXCEPT_TYPEDEF
    EMACS_ATTRIBUTE_NONNULL(1);
...
struct emacs_env_25 {
  ...
  void (*non_local_exit_signal)(emacs_env *env, emacs_value symbol,
                                emacs_value data) EMACS_ATTRIBUTE_NONNULL(1);
  ...
  emacs_value (*make_function)(
      ...
      emacs_value (*func)(emacs_env *env, ptrdiff_t nargs, emacs_value *args,
                          void *data) EMACS_NOEXCEPT EMACS_ATTRIBUTE_NONNULL(1),
      const char *docstring, void *data) EMACS_ATTRIBUTE_NONNULL(1, 4);

  emacs_value (*funcall)(emacs_env *env, emacs_value func, ptrdiff_t nargs,
  ...
  bool (*copy_string_contents)(emacs_env *env, emacs_value value, char *buf,
                               ptrdiff_t *len) EMACS_ATTRIBUTE_NONNULL(1, 4);
  ...
  void *(*get_user_ptr)(emacs_env *env,
                        emacs_value arg)EMACS_ATTRIBUTE_NONNULL(1);
...
//                                       emacs_value arg))(void *) EMACS_NOEXCEPT;
  ...
  void (*make_interactive)(emacs_env *env, emacs_value function,
                           emacs_value spec) EMACS_ATTRIBUTE_NONNULL(1);

  /* Create a unibyte Lisp string from a string.  */
  emacs_value (*make_unibyte_string)(emacs_env *env, const char *str,
                                     ptrdiff_t len)
      EMACS_ATTRIBUTE_NONNULL(1, 2);
};
...
extern int emacs_module_init(struct emacs_runtime *runtime) EMACS_NOEXCEPT
    EMACS_ATTRIBUTE_NONNULL(1);
