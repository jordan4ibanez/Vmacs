...
(custom-set-variables
 ...
 '(package-selected-packages
   '(glsl-mode use-package markdown-mode hl-todo paredit kind-icon corfu diff-hl real-auto-save treemacs treemacs-tab-bar treemacs-projectile treemacs-persp treemacs-magit treemacs-icons-dired rainbow-delimiters highlight-parentheses ergoemacs-mode doom-themes dashboard centaur-tabs)))
